...
zstyle :compinstall filename '/nfs/stak/students/y/yanc/.zshrc'
...
if [[ -z `echo $PATH | grep "yanc/local/bin"` ]];then
    export PATH=$PATH:.:~/local/bin:~/444/
fi
...
# remove git push check on ssh askpass
unset SSH_ASKPASS
